...
public class ItemTurbine extends ElementsEnanchedDifficulty.ModElement {
	@GameRegistry.ObjectHolder("enancheddifficulty:turbine")
	public static final Item block = null;
	public ItemTurbine(ElementsEnanchedDifficulty instance) {
		super(instance, 4);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("enancheddifficulty:turbine", "inventory"));
	}
